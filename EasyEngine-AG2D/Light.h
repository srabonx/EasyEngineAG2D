...
namespace EE {
	...
	public:
		...
		void setDirection(double x, double y, double z) { setDirection(D3DXVECTOR3((float)x, (float)y, (float)z)); }
		D3DXVECTOR3 getDirection() { return this->p_light.Direction; }
		void setPosition(D3DXVECTOR3 pos) { this->p_light.Position = pos; }
		void setPosition(double x, double y, double z) { setPosition(D3DXVECTOR3((float)x, (float)y, (float)z)); }
		D3DXVECTOR3 getPosition() { return this->p_light.Position; }
		void Update();
		void Show();
		void Hide();
