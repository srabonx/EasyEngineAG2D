...
namespace EE {
	...
	Vector3 Math::LinerVelocity(double angle)
	{
	...
	double Math::Distance( Vector3& v,  Vector3& vec2)
	{
		return Distance(v.getX(), v.getY(), vec2.getX(), vec2.getY());
	}
